...
<template>
  <div class="flex flex-col justify-between p-5 text-left bg-white border shadow-sm rounded-2xl border-slate-200 md:p-6 lg:col-span-2">
    <div class="mb-4 select-none">
      <h3 class="text-base font-bold text-slate-900 font-display">Real-time Booking & Ticket Influx</h3>
      <p class="font-sans text-xs text-slate-400">Chronological telemetry monitoring booking checks and support requirements.</p>
    </div>
    ...
    <div class="flex items-center gap-4 mt-4 text-xs select-none">
      <div class="flex items-center gap-1.5">
        ...
        <span class="font-medium text-slate-600">Storage Bookings (Max 56)</span>
      </div>
      <div class="flex items-center gap-1.5">
        <div class="w-3 h-3 rounded-sm bg-violet-500" />
        <span class="font-medium text-slate-600">Support Backlog (Max 19)</span>
      </div>
    </div>
  </div>
</template>
